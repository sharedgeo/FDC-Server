...
CREATE TABLE public.tickets (
    ...
    ticket_type text,
    ticket_url text,
    geom public.geometry(MultiPolygon,6344),
...
--
-- Name: index_tickets_on_geom; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_tickets_on_geom ON public.tickets USING gist (geom);
